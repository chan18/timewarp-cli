namespace TimeWarpCli.Server
{
  ...
  using TimeWarpCli.Configuration;
  using TimeWarpCli.Features.Bases;
  using TimeWarpCli.Features.Superheros;
  using TimeWarpCli.Infrastructure;

  public class Startup
  {
    private const string SwaggerVersion = "v1";
    private readonly IConfiguration Configuration;
    private string SwaggerApiTitle => $"TimeWarpCli API {SwaggerVersion}";
